...
#SBATCH --job-name=08_ab_prepare_depth_files
#SBATCH --output=08_ab_prepare_depth_files.out
#SBATCH --error=08_ab_prepare_depth_files.err
...
awk '$3 == "gene" {print $1"\t"$4"\t"$5}' rawg0133_Haliotis_rufescens_Bogan.gff | uniq > genes_unsorted.bed
