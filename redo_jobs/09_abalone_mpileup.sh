...
bcftools mpileup -Ou -f /home/snbogan/repadapt/vcf/invert/genomes/abalone/rawg0133_Haliotis_rufescens_Bogan.fna --bam-list /home/snbogan/repadapt/vcf/invert/08_cnv/abalone/08_list1.txt -q 5 -r $CHROM -I -a FMT/AD,FMT/DP | bcftools call -S ploidymap.txt -G - -f GQ -mv -Ov > $CHROM\.vcf
