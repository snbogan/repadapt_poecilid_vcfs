...
cd /data/colibri/kelley_lab/bogan/RepAdapt/poecilid_vcfs/03_bwa_map/poec/
...
# Reference genome
REFGENOME=/data/colibri/kelley_lab/bogan/RepAdapt/poecilid_vcfs/02_bwa_index/poec/rawg0041_Poecilia_mexicana_kelley.fasta

# Output directory
OUTDIR=/data/colibri/kelley_lab/bogan/RepAdapt/poecilid_vcfs/03_bwa_map/poec/bwa_output
