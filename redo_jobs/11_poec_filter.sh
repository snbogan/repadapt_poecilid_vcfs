...
#SBATCH --qos=pi-jkoc
#SBATCH --job-name=11_poec_filter
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=11_poec_filter.out
#SBATCH --error=11_poec_filter.err
...
bcftools filter -e 'AC=AN || MQ < 30' poec.vcf.gz -Ov > rawg0041_Poecilia_mexicana_kelley.vcf
...
bgzip rawg0041_Poecilia_mexicana_kelley.vcf
tabix -p vcf rawg0041_Poecilia_mexicana_kelley.vcf.gz
