...
#SBATCH --qos=pi-jkoc
#SBATCH --job-name=07_poec_realign_indel
#SBATCH --time=5-00:00:00
#SBATCH --mem-per-cpu=60G
#SBATCH --mail-user=snbogan@ucsc.edu
#SBATCH --mail-type=ALL
#SBATCH --array=1-160
#SBATCH --output=07_poec_realign_indel_out/07_poec_realign_indel_%A_%a.out
#SBATCH --error=07_poec_realign_indel_err/07_poec_realign_indel_%A_%a.err
...
GenomeAnalysisTK -T RealignerTargetCreator \
 -R /data/colibri/kelley_lab/bogan/RepAdapt/02_bwa_index/poec/rawg0041_Poecilia_mexicana_kelley.fasta \
