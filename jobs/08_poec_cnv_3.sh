...
#SBATCH --job-name=poec_depth_table
#SBATCH --output=poec_depth_table.out
#SBATCH --error=poec_depth_table.err
...
cut -f2 list.txt | sort | uniq > /hb/home/snbogan/RepAdapt/poecilid_vcfs/08_cnv/poec/samples.txt
