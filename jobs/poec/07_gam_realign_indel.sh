...
#SBATCH --qos=pi-jkoc
#SBATCH --job-name=gam_realign_indel
#SBATCH --time=5-00:00:00
#SBATCH --mem-per-cpu=60G
#SBATCH --mail-user=snbogan@ucsc.edu
#SBATCH --mail-type=ALL
#SBATCH --array=1-40
#SBATCH --output=gam_realign_indel_out/out_%A_%a.out
#SBATCH --error=gam_realign_indel_err/err_%A_%a.err
...
# Move to wd 2
cd /hb/home/snbogan/RepAdapt/poecilid_vcfs/05_rg/gam/
...
GenomeAnalysisTK -T RealignerTargetCreator \
 -R /hb/home/snbogan/RepAdapt/poecilid_vcfs/02_bwa_index/gam/rawg0043_Gambusia_sexradiata_kelley.fasta \ -I $INPUT -o $OUTPUT\.intervals

GenomeAnalysisTK -T IndelRealigner -R \
 /hb/home/snbogan/RepAdapt/poecilid_vcfs/02_bwa_index/gam/rawg0043_Gambusia_sexradiata_kelley.fasta \
