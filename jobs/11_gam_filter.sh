...
#SBATCH --output=gam_filter.out
#SBATCH --error=gam_filter.err
...
bcftools filter -e 'AC=AN || MQ < 30' gam.vcf.gz -Ov > gam_filtered.vcf
...
bgzip gam_filtered.vcf
tabix -p vcf gam_filtered.vcf.gz
