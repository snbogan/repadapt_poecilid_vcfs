...
#SBATCH --job-name=08_ab_depth_table
#SBATCH --output=08_ab_depth_table.out
#SBATCH --error=08_ab_depth_table.err
...
cut -f2 list.txt | sort | uniq > /home/snbogan/repadapt/vcf/invert/08_cnv/abalone/samples.txt
