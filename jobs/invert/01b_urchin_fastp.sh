...
#SBATCH --qos=pi-jkoc
#SBATCH --job-name=01b_urchin_fastp
#SBATCH --time=3-00:00:00
#SBATCH --mail-user=snbogan@ucsc.edu
#SBATCH --mail-type=ALL
#SBATCH --output=01b_urchin_fastp_out/out_%A_%a.out
#SBATCH --error=01b_urchin_fastp_err/err_%A_%a.err
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=30G
#SBATCH --array=1-140

# Move to working directory
cd /hb/home/snbogan/repadapt/vcf/invert/01_fastp/sra_data/urchin/
